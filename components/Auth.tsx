...
const Auth: React.FC<AuthProps> = ({ onAuthSuccess, onGuestAccess, onShowTermsAndConditions }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex md:w-[55%] bg-primary-600 md:bg-white md:dark:bg-[#111827] p-6 md:p-12 flex-col justify-start md:justify-between border-b md:border-b-0 md:border-r border-primary-500 md:border-gray-100 dark:md:border-gray-800 relative z-0">
                ...
                <div className="flex items-center justify-center pt-2 md:flex-1 md:pt-10 md:pb-0 z-0 overflow-visible">
                    ...
                    <img 
                        ...
                        className="md:hidden w-full max-w-[340px] object-contain transform translate-y-24 scale-110" 
                    />
                    <img 
            ...
            <motion.div 
                drag={isSigningUp && typeof window !== 'undefined' && window.innerWidth < 768 ? "y" : false}
                ...
                className="w-full md:w-[45%] p-6 pt-10 md:p-8 bg-white dark:bg-[#111827] flex flex-col flex-1 pb-10 md:pb-8 md:max-h-[90vh] md:overflow-y-auto rounded-t-[32px] md:rounded-none -mt-8 md:mt-0 relative z-10 shadow-[0_-12px_30px_rgba(0,0,0,0.08)] md:shadow-none touch-none"
            >
